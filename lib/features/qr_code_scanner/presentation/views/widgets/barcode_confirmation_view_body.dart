...
class BarcodeConfirmationViewBody extends StatelessWidget {
  const BarcodeConfirmationViewBody({super.key});
          ...
          Column(
            ...
            children: [
              ...
              CustomButton(
                ...
                onPressed: () {
                  context.go(AppRoutes.secondBarcodeConfirmationView);
                },
              )
            ],
          ),
